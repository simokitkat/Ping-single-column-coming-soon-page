...
I learned about the `novalidate` attibute that can be added to the form tag so that the form doesn't get validated by the default so that it's validated JavaScript instead.
